<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DynamicCvProject.Default" %>
...
<head>
    ...
    <link href="/web1/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <link href="/web1/css/style.css" type="text/css" rel="stylesheet" media="all">
    <link href="/web1/css/fontawesome-all.min.css" rel="stylesheet">
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="/web1/images/123123.jpeg" alt="news image" class="img-fluid navimg" style="width: 150px; height: 150px">
            <h1 class="top_hd mt-2"><a href="#">Öykü Öztürk</a></h1>
            <p class="top_hdp mt-2">Yazılım Geliştiricisi</p>
        </div>
        <header>
            <div class="nav-top">
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesaj: " TextMode="MultiLine" Height="25"></asp:TextBox>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Gönder" OnClick="Button1_Click"/>
                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" Text="Reset" />
                    <div class="clearfix"></div>
                </form>
            </div>
            <div class="cpy-right text-center">
                <p>
                    © 2023 Conjoint. Tüm hakları saklıdır. | Design by
